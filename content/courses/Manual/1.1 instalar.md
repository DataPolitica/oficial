...
Se puede descargar en el siguiente enlace (seleccionar opcción "Open Source Licence"):
...
Para iniciar el uso del R Studio debemos conocer cuáles son sus principales partes y cuál es la función de cada una de estas. 
