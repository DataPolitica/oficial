...
La lógica siempre será la misma. Crear repositorio-> clonarlo localmente -> seleccionar el repositorio local como carpeta de trabajo -> subir editar documentos -> Poner Commit to Master -> Colocar **Push**
...
Cuando habras tu GitHub Desktop vas a la parte superior que dice "Fetch origin".
