...
Creemos un Script para ver cómo funciona. Hemos creado un script en nuestra carpeta local que está linkeada a nuestro repositorio. Una vez hecho el cambio (creación de Script) nos vamos al GitHub Desktop. 
