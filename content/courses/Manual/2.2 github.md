...
linktitle: 2.2 Enlazar con la nube, GitHub y R
toc: true
type: docs
...
Hay dos formas de utilizar el GitHub cuando usas el R Studio: 1) utilizando el GitHub Desktop y 2) enlazando el R Studio con el GitHub

## PRIMERA OPCIÓN: Utilizar GitHub Desktop para subir y bajar cambios a la nube

## 0. Instalar el programa GIT
...
## 4. Clonar un repositorio (de la nube) en mi disco local
...
## 5. Agregar cambios y enviarlos a la nube (PUSH)
...
## 6. Descargar cambios realizados en la nube por ti o un colaborador (PULL)
